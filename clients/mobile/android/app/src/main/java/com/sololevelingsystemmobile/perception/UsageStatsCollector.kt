 ...
 *
 * 写入格式（对齐 desktop 的 sls-watcher-window_windows + currentwindow 命名规则）：
 *   bucket_id   = sls-watcher-usage_android
 *   kind        = usage
...
object UsageStatsCollector {
  ...
  private const val BUCKET_ID = "sls-watcher-usage_android"
