...
const LS_SIDEBAR = 'sls-bench-sidebar-collapsed'
const LS_MIRROR_POS = 'sls-bench-mirror-pos'
const LS_MIRROR_MODE = 'sls-bench-mirror-mode'
const LS_MIRROR_DOCK_H = 'sls-bench-mirror-dock-h'
    ...
    <div className="bench">
      ...
      <div className="bench-body">
        ...
        <main className="panels">
          {!synced && <div className="loading">首次同步手机 DB 中…（adb exec-out perception.db）</div>}
